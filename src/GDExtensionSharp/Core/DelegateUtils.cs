        ...
        internal static class RuntimeTypeConversionHelper
        {
            ...
            private static readonly System.Collections.Generic.Dictionary<Type, ConvertToSystemObjectFunc>
                ToSystemObjectFuncByType = new()
                {
                    ...
                    [typeof(NodePath)] = (in godot_variant variant) => VariantUtils.ConvertTo<NodePath>(variant),
                    [typeof(Rid)] = (in godot_variant variant) => VariantUtils.ConvertTo<Rid>(variant),
                    [typeof(GDExtensionSharp.Collections.Dictionary)] = (in godot_variant variant) =>
                        VariantUtils.ConvertTo<GDExtensionSharp.Collections.Dictionary>(variant),
                    [typeof(GDExtensionSharp.Collections.Array)] =
                        (in godot_variant variant) => VariantUtils.ConvertTo<GDExtensionSharp.Collections.Array>(variant),
            ...
            public static object? ConvertToObjectOfType(in godot_variant variant, Type type)
            {
                ...
                if (type.IsGenericType)
                {
                    ...
                    if (genericTypeDef == typeof(GDExtensionSharp.Collections.Dictionary<,>))
                    {
                        var ctor = type.GetConstructor(BindingFlags.Default,
                            new[] { typeof(GDExtensionSharp.Collections.Dictionary) });
                    ...
                    if (genericTypeDef == typeof(GDExtensionSharp.Collections.Array<>))
                    {
                        var ctor = type.GetConstructor(BindingFlags.Default,
                            new[] { typeof(GDExtensionSharp.Collections.Array) });
                        ...
                        return ctor.Invoke(new object?[]
                        {
                            VariantUtils.ConvertTo<GDExtensionSharp.Collections.Array>(variant)
                        });
                    }
                }
