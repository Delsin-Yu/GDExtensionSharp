...
namespace GDExtensionSharp
{
    ...
    /// It consists of a <see cref="GDExtensionSharp.Basis"/> (first 3 columns) and a
    ...
    {
        /// <summary>
        /// The <see cref="GDExtensionSharp.Basis"/> of this transform. Contains the X, Y, and Z basis
        ...
        /// </summary>
        /// <param name="basis">The <see cref="GDExtensionSharp.Basis"/> to create the basis from.</param>
        /// <param name="origin">The origin vector, or column index 3.</param>
