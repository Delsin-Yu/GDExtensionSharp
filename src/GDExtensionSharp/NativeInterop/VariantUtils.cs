...
using GDExtensionSharp.Collections;
...
namespace GDExtensionSharp.NativeInterop
{
    public static partial class VariantUtils
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static godot_variant CreateFromArray<[MustBeVariant] T>(Array? from)
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Array ConvertToArray<[MustBeVariant] T>(in godot_variant p_var)
            => Array.CreateTakingOwnershipOfDisposableValue(ConvertToNativeArray(p_var));
